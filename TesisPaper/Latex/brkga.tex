...
\begin{figure}[h]
	...
	\floatfoot{En la figura \ref{fig:biasCrossover} podemos observar como el individuo resultante hereda primer alelo del individuo de no-elite por que el número real aleatorio en la primera posición resulto mayor a $0.70$}
\end{figure}
